...
@app.post("/login")  #to generate acess token and refresh token
...
@app.post("/token", response_model=Token) #used refresh token to generate new acess token
...
@app.get("/users/me/", response_model=User) #use that acesss token until 60 seconds
