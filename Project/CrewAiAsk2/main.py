...
async def process_inputs(inputs_details: InputDetails):
    ...
    restaurant_tool = WebsiteSearchTool(
        url="https://www.booking.com",
        search_terms="restaurants in user's destination"
    )
    hotel_tool = WebsiteSearchTool(
        url="https://www.booking.com",
    ...
    tasks = [tourist_search_task, hotel_search_task, restaurant_search_task]
    individual_results = []
    for task in tasks:
